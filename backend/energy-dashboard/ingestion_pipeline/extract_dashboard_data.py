...
try:
    ...
    if 'meter' in last_log:
        ...
        if primary_meter:
            ...
            # Energy data
            dashboard_data['energy_data']['Total_Import_kWh'] = round(primary_meter.get('WHImp', 0) / 1000, 2)
            dashboard_data['energy_data']['Total_Export_kWh'] = round(primary_meter.get('WHExp', 0) / 1000, 2)
    ...
    if 'inverter' in last_log:
        ...
        dashboard_data['energy_data']['Day_Generation_kWh'] = round(total_day_generation / 1000, 2)
    ...
    with open('filtered_dashboard_data.json', 'w') as f:
    ...
    print(f"\nFull data saved to: filtered_dashboard_data.json")
